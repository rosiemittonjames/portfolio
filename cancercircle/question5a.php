...
<head>
  ...
  <title>Cancer Journey</title>
  <link href="question5a.css" rel="stylesheet" type="text/css">
  ...
  <main>
    <section class="grid-container-flex">
      ...
      <div class="question-header">
        ...
        <h2><a href="question6.php">Skip</a></h2>
    </div>

      <form action="question6.php" method="POST" id="questionForm">
        <div class="container">
          <h1>On my cancer journey</h1>
          ...
          <label for="treatment"><b>What treatment are you having?</b></label>
