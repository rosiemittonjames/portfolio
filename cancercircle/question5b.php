...
<head>
    ...
    <link href="question5b.css" rel="stylesheet" type="text/css">
...
<body>
    <main>
        ...
        <h2><a href="question6b.php">Skip</a></h2>
    </div>

                <form action="question6b.php" method="POST">
                    <div class="container">
                      <h1>I'm a cancer survivor</h1>
                  
                      <label for="cancertype"><b>What type of cancer did you have?</b></label>
                    ...
                    <label for="treatment"><b>What treatment did you have?</b></label>
